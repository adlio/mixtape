...
///
/// ```ignore
/// use mixtape::{BedrockProvider, ClaudeSonnet4_5};
///
...
impl BedrockProvider {
    ...
    ///
    /// ```ignore
    /// use mixtape::{BedrockProvider, ClaudeSonnet4_5, NovaMicro};
    ///
    ...
    ///
    /// ```ignore
    /// use mixtape::{BedrockProvider, ClaudeSonnet4_5, InferenceProfile};
    ///
