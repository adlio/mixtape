// Example demonstrating multi-turn conversations with Anthropic's direct API
//
...
//
// Run with: cargo run --example multi_turn_anthropic --features anthropic

use mixtape::{Agent, ClaudeHaiku4_5};

#[tokio::main]
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    println!("=== Multi-Turn Conversation Demo (Anthropic) ===\n");
